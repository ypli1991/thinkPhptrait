...
// 记录内存初始使用
define('MEMORY_LIMIT_ON',function_exists('memory_get_usage'));//是否限制最大的访问内存
if(MEMORY_LIMIT_ON) $GLOBALS['_startUseMems'] = memory_get_usage(); //把最大内存量放到超全局变量中
// 版本信息
const THINK_VERSION     =   '3.2.3';         //定义版本
